                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <div class="card-title">
                            <h5 style="height: 30%;"><?php echo $row['Product_Name'] ?>
                            </h5>
                        </div>
                        <div class="form-row">

                            <p class="py-2">จำนวน &nbsp;</p>

                            <input type="number"
                                class="form-control form-control-sm col-sm-3  col-2 col-lg-3 float-sm-right"
...
<div class="card-body">
    <div class="row">
        ...
        <div class="col-lg-3 col-sm-6 portfolio-item">
            ...
            <form
                action="shopproduct.php?action=add&id=<?php echo $row["Product_ID"]; ?>&&typeproduct=<?php echo $typeproduct ?>"
                method="post">
