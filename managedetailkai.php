...
<body>
                ...
                <form action="php/insert.php" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <label for="inputPassword" class="col-sm-2 col-form-label py-2 ">หัวข้อ</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="kainame" name="kainame" placeholder="หัวข้อ"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1" class="py-2">รายละเอียด</label>
                            <textarea class="form-control" id="kaidetail" name="kaidetail" rows="5"
                                placeholder="รายละเอียด" required></textarea>
                        </div>

                        <div class="form-group row ">

                            <label class="col-sm-1 py-2">รูปไก่ชน</label>
                            <div class="custom-file col-sm-5" data-callback=" PhotoChcallback">
                                <input type="file" class="custom-file-input product-file" id="file"
                                    aria-describedby="inputGroupFileAddon02" name="file">
                                <label class=" custom-file-label product-label" for="inputGroupFile02">เลือกไฟล์</label>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" name="submitkaidetail" class="btn btn btn-primary"
                            id="submitkaidetail">Save
                            changes</button>
                    </div>
    ...
    <div class="container">
        ...
        if (isset($_POST["txtKeyword"])) {
            ...
            $keyword =  ($strKeyword);
            //echo $keyword;
            $selectkai = "SELECT * FROM `kai` WHERE `kai`.`kai_ID` LIKE '%" . $keyword . "%' ";
            $resultkai = mysqli_query($conn, $selectkai);
            $selectkai2 = "SELECT * FROM `kai` WHERE `kai`.`kai_ID` LIKE '%" . $keyword . "%' ";
            $resultkai2 = mysqli_query($conn, $selectkai);
            $ckrow2 = mysqli_fetch_array($resultkai2);
        ...
        ?>
            ...
            <?php
                ...
                $selectkai= "SELECT * FROM `kai` WHERE `kai`.`kai_ID` ORDER BY `kai`.`kai_Name` ASC";
                $resultkai = mysqli_query($conn, $selectkai);
            }
        } else {
    ...
    <div class="container-fluid py-2">
        <div class="card ">
            <h5 class="card-header text-center">จัดข้อมูล</h5>
                ...
                <table class="table table-bordered table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th width="15%" class="text-center">ลายละเอียด</th>
                    ...
                    <tbody>
                        ...
                        */
                        ...
                        while ($rowpkai = mysqli_fetch_array($resultkai)) {
                        ?>
                        <tr>
                            <th width="12%" class="text-center"><img class="img-responsive"
                                    src="img\kai\<?php echo $rowpkai["kai_Photo"] ?>"
                                    alt="<?php echo $rowpkai["kai_Photo"] ?>" width="120" height="80">
                            </th>

                            <th><?php echo $rowpkai["kai_Name"] ?></th>
                            <th><?php echo $rowpkai["kai_Details"] ?></th>
                            ...
                            <td>
                                <div class="text-center">
                                    <a href="php/delete.php?kai_ID=<?php
                                                                            echo $rowpkai["kai_ID"];
                                                                            ?>" style="color:#000000" ">
